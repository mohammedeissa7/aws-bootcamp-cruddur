...
## CLI installation and configuration on my pc 
this is my first step on AWS let's start :
I followed : [AWS CLI Install Instructions]https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html
I put this command to install aws cli :
```
...
We need to turn on Billing Alerts 
